                ...
                case "startGamePlay":
                    if player.IsOwner {
                        ...
                        for name, p := range room.Data.Players {
                            if room.Data.CompeteMode && p.Id == player.Id {
                                continue 
                            }
...
type RoomData struct {
    ...
    CompeteMode  bool                 `json:"compete_mode"`
...
func (room *RoomActual) CheckAutoStageChange() {
    if len(room.Data.PlayRounds) > int(room.Data.PlayRound) {
        ...
        for k, vx := range room.Data.Players {
            ...
            if vx.Id == room.Data.Owner && room.Data.CompeteMode {
                continue
            }
